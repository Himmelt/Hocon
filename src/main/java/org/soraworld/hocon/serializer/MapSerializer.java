...
final class MapSerializer extends TypeSerializer<Map<?, ?>, NodeMap> {
    ...
    @NotNull
    public Map<?, ?> deserialize(@NotNull Type fieldType, @NotNull NodeMap node) throws HoconException {
    ...
    @NotNull
    public NodeMap serialize(@NotNull Type fieldType, @NotNull Map<?, ?> value, @NotNull Options options) throws HoconException {
        Type[] arguments = Reflects.getActualTypes(Map.class, fieldType);
        if (arguments != null && arguments.length == 2) {
